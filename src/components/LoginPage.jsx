          ...
          <div className="w-[400px] h-auto space-y-5">
            ...
            >
              ...
              <div className="flex px-2 justify-center items-center pt-5 space-x-7">
                <Link to="/signin">
                  <button className=" px-5 py-1 rounded-3xl transition-transform duration-500 transform hover:border-bestosyellow hover:text-bestoswhite  hover:bg-bestosyellow hover:scale-105  font-bold border-bestoswhite text-bestoswhite border-2 ">
                    SIGN UP
                  </button>
                </Link>
              </div>
